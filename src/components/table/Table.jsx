...
const Table = ({
  ...
  maxHeight = null, // e.g. "max-h-[calc(100vh-220px)] overflow-y-auto"
  minWidth = "min-w-[900px]", // e.g. "min-w-[900px]" or null
}) => {
  ...
  return (
    <div className={`overflow-x-auto ${maxHeight ? `${maxHeight} pr-2` : "overflow-visible"} relative`}>
      <table className={`w-full ${minWidth ? minWidth : ""} table-fixed border-separate border-spacing-y-3 text-sm -pr-2`}>
        <thead className={maxHeight ? "sticky top-0 z-10 bg-[#f8fafc]" : ""}>
          <tr>
