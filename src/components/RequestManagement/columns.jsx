// frontend/src/components/RequestManagement/columns.jsx
import StatusBadge from "../StatusBadge";
import RequestCategoryBadge from "../RequestCategoryBadge";
...
export const requestColumns = [
...

  {
    header: "TIMESTAMP",
    width: "w-48",
    render: (row) => new Date(row.timestamp).toLocaleString("en-GB"),
  },
